...
{ 
 ...
 ,
 // Search with raw SQL (supports searching by Subject_Name or Student_Name)
 ...
 ,
 // Search all exams for a specific student (used by Student/Agent portals)
 Search_Exam_Master_By_Student:function(Student_Id_,callback)
 {
   return db.query("CALL Search_Exam_Master_By_Student(?)",[Student_Id_],callback);
 }
 ,
 // Get exam master by student Id (alternate SP-based lookup)
